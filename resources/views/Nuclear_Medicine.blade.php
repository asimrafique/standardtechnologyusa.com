            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="content-part">
                        ...
                        <h3 style="color: black" class="mt-4"> Benefits </h3>
                        <p>PC-based Dose Calibrator running on Windows** </p>
                        <ul>


                            <li>Optional space-saving NetTop PC System</li>
                            <li>Optional monitor with or without touch screen function</li>
                            <li>Expandable nuclide database</li>
                            <li>Calculation of the activity to assure the correct time of medication administration</li>
                            <li>Integrated quality controls according to DIN 6855-11 (IEC 61948-4) and DIN 61303 (IEC 61303)</li>
                            <li>Various mounting options</li>


                        </ul>

<h3 style="color: black" class="mt-4"> Key Figures  </h3>
                        <p>PC-based Dose Calibrator running on Windows** </p>
                        <ul>

                            <li>more than 30 nuclides
                            </li>
                            <li>50 GBq (Tc-99m)</li>
                            <li>70 GBq (F-18)</li>
                            <li>5  % basic error</li>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>1</td>
                                <th scope="row">Measuring range: e.g. Tc-99m / F-18

                                </th>
                                <td>40 kBq to 50/200* GBq (* 7% additional error)</td>
                                <td> 60 kBq to 70/300* GBq</td>

                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>Measuring range settings 			 </td>
                                <td>Automatically, alternatively fixed measuring range</td>
                                <td>//</td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
                ...
                <div class="col-lg-6 md-pd-top-45">
                    <div class="img-part">
                        <img src="assets/img/products/DOSE CALIBRATOR.jpg"  class="img
